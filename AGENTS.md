...
- 以后查询 **OpenHarmony / HarmonyOS 官方文档** 时，默认优先使用：`https://gitcode.com/openharmony/docs/tree/OpenHarmony-7.0-Release`
- 默认以该仓库的 `OpenHarmony-7.0-Release` 分支内容作为官方文档参考基线。
- 本规则**仅适用于官方文档检索**，不影响代码仓库、Issue、README、社区帖子、博客或其他第三方资料的查找。
- 如果用户在当前任务中明确指定了其他文档来源、其他分支或其他站点，则以用户指令为准。

*最后更新：2026-07-13 - 更新鸿蒙官方文档默认地址及参考基线*

...
> 基于 `master` 分支提交记录整理，版本号以提交标题中的 `v10~v17` 为准；`2026-03-06` 为当前最新迭代。

| 里程碑 | 版本/提交 | 日期 | 完成内容 |
|---|---|---|---|
| M0 | `043cf4b` | 2026-02-09 | 初始化 SecurityTool HarmonyOS 项目 |
| M1 | `8a0e275` | 2026-02-09 | 安全总览 + 防火墙模块落地（主功能框架成型） |
| M2 | `d602e55` | 2026-02-11 | 外设管理模块一期：接口管控、白名单、黑名单 |
| M3 | `7cc04fd` | 2026-02-13 | 深色主题系统 + 身份鉴别模块 |
| M4 | `29397e8` (`v10`) | 2026-02-13 | 隐藏系统标题栏，外设管理模块重构 |
| M5 | `ac1c1a0` (`v11`) | 2026-02-25 | 工具设置模块上线，认证/安全存储能力完善 |
| M6 | `726ed9d` (`v12`) | 2026-02-25 | 文档、版本号、权限列表同步 |
| M7 | `b1cd7a5` (`v13`) | 2026-02-26 | 启动认证功能落地，测试框架搭建 |
| M8 | `b0349b9` (`v14`) | 2026-02-26 | 日志管理模块 + 帮助反馈页面 |
| M9 | `00443ef` (`v15`) | 2026-03-03 | 修复日志高频订阅卡顿，提升日志模块稳定性 |
| M10 | `a3c816e` (`v16`) | 2026-03-04 | 统一包名并同步安全中心多模块更新 |
| M11 | `a92022f` (`v17`) | 2026-03-05 | 修复审计订阅兼容回退与诊断展示 |
| M12 | `43074ca` | 2026-03-06 | 新增路由动作测试场景，加固日志运行时稳定性 |
...
**功能更新：**
- 修复日志订阅参数映射、批量入库与刷新，过滤内部审计自激，优化 OOM/卡顿稳定性

**文件变更：**
- 相关文件详见 README.md 的版本历史中的 v15 条目

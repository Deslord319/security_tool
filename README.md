...
[![Version](https://img.shields.io/badge/Version-v17-brightgreen)](DEVLOG.md)
...
HarmonyShield/
├── AppScope/                       # 应用全局配置
│   └── app.json5                   # 应用配置文件 (bundleName、版本等)
│
├── entry/                          # 应用主模块
│   ├── src/main/ets/               # 源代码目录
│   │   ├── entryability/           # 应用入口 (EntryAbility)
│   │   ├── entrybackupability/     # 备份能力
│   │   ├── enterpriseadminability/ # 企业管理员能力 (MDM)
│   │   ├── pages/                  # 页面组件 (MainPage、DashboardPage 等)
│   │   ├── views/                  # 视图模块 (侧边栏、表格等)
│   │   ├── components/             # 通用组件 (StatCard、RuleTable 等)
│   │   ├── services/               # 服务层 (API 封装、业务逻辑)
│   │   ├── models/                 # 数据模型 (TypeScript 接口、类)
│   │   ├── constants/              # 常量定义 (路由、配置项)
│   │   ├── utils/                  # 工具函数
│   │   └── theme/                  # 主题系统 (深色/浅色模式)
│   ├── src/main/resources/         # 资源文件 (字符串、图片、媒体)
│   ├── src/test/                   # 单元测试代码

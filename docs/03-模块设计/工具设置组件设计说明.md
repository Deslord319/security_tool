...
|---|---|---|---|
| 1.0.6 | 2026-05-11 | Codex | 工具设置认证方式业务顺序收敛到 `ToolSettingsModels.ets`，ViewModel 不再依赖展示层 option。 |
| 1.0.5 | 2026-05-11 | Codex | 将工具设置配置模型和 Preferences Key 拆分到 `ToolSettingsModels.ets`，认证方式枚举迁入 `AuthModels.ets`。 |
